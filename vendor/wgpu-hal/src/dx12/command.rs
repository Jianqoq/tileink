...
impl crate::CommandEncoder for super::CommandEncoder {
        ...
        T: Iterator<Item = crate::TextureBarrier<'a, super::Texture>>,
    {
        ...
        for barrier in barriers {
            ...
            } else if s0 == Direct3D12::D3D12_RESOURCE_STATE_UNORDERED_ACCESS {
                // Same-state UAV accesses still need ordering, including write-only textures.
                // The tracker supplies the required dependencies; checking only READ_WRITE
                // dropped write-after-write barriers and let later clears race earlier writes.
                let raw = Direct3D12::D3D12_RESOURCE_BARRIER {
                    Type: Direct3D12::D3D12_RESOURCE_BARRIER_TYPE_UAV,
                    Flags: Direct3D12::D3D12_RESOURCE_BARRIER_FLAG_NONE,
                    Anonymous: Direct3D12::D3D12_RESOURCE_BARRIER_0 {
