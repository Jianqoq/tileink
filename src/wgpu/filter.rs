    ...
    fn create_bind_group(
        ...
        device.create_bind_group(&::wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                bind_buffer(32, bindings.segment_p0x),
                bind_buffer(33, bindings.segment_p0y),
                bind_buffer(34, bindings.segment_p1x),
                bind_buffer(35, bindings.segment_p1y),
                bind_buffer(36, bindings.segment_y_edge),
                bind_buffer(37, bindings.layer_stack_tags),
                bind_buffer(38, bindings.layer_stack_draws),
                bind_buffer(39, bindings.layer_stack_payloads),
                bind_buffer(40, transfer_tables.unwrap_or(&self.dummy_read)),
                bind_buffer(41, brush_data),
                bind_buffer(42, brush_params),
                bind_buffer(43, brush_payloads),
                bind_buffer(44, convolve_kernels),
                bind_buffer(45, turbulence_selectors),
                bind_buffer(46, turbulence_gradients),
                bind_buffer(47, path_range_starts),
                bind_buffer(48, path_range_ends),
                bind_buffer(49, path_p0x),
                bind_buffer(50, path_p0y),
                bind_buffer(51, path_p1x),
                bind_buffer(52, path_p1y),
                bind_buffer(
