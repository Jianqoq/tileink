...
pub(crate) struct WgpuSceneBuffers {
    ...
    image_resource_atlas_size: (u32, u32),
...
impl WgpuSceneBuffers {
    pub(crate) fn new(device: &::wgpu::Device) -> Self {
        let image_resource_atlas = create_image_resource_atlas_texture(device, 1, 1);
        let image_resource_atlas_view =
            image_resource_atlas.create_view(&::wgpu::TextureViewDescriptor::default());
        Self {
