...
var<workgroup> shared_blur_pixels: array<u32, max(SHARED_BLUR_TILE_WIDTH * (SHARED_BLUR_TILE_HEIGHT + 2u * SHARED_BLUR_MAX_RADIUS), SHARED_BLUR_TILE_HEIGHT * (SHARED_BLUR_TILE_WIDTH + 2u * SHARED_BLUR_MAX_RADIUS))>;
