...
use crate::{
    cubecl::{
        ...
        buffer::CubeBuffer,
        pipelines::common::{
            blend_premul_u8, combine_alpha, draw_fill_rule_at, draw_tag_at, pack_premul_rgba8,
            sample_brush, scale_premul_u8, src_over_premul_u8,
        },
        ...
        types::{
            ...
            CUBE_SDF_LINE_SHADOW, CUBE_SDF_RECT, CUBE_SDF_RECT_SHADOW, CUBE_SDF_RECT_STROKE,
        },
    },
    shared::{
        bounds::Bounds,
