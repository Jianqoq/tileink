                ...
                if global_y >= draw_pixel_y0[draw_i] {
                    if global_y < draw_pixel_y1[draw_i] {
                        ...
                        alpha = gpu_sdf_alpha_from_encoded(
                            ...
                            sdf_r2[sdf_i],
                            sdf_r3[sdf_i],
                            sdf_stroke_top[sdf_i],
                            sdf_stroke_right[sdf_i],
                            sdf_stroke_bottom[sdf_i],
                            sdf_stroke_left[sdf_i],
                            sdf_shadow_offset_x[sdf_i],
                            sdf_shadow_offset_y[sdf_i],
                            sdf_shadow_expand[sdf_i],
                            sdf_shadow_intensity[sdf_i],
                        );
                    }
                }
            }
