...
use tileink::{
    FillRule, Radius, RectShadowOptions, Scene, SdfArc, SdfLine, SdfLineCap, ShadowOptions,
};
...
pub fn sdf_shape_shadows_scene() -> (Scene, u32, u32) {
    ...
    scene.push_circle(circle, Color::from_rgb8(59, 130, 246), FillRule::NonZero);
    ...
    scene.push_sdf_arc(arc, Color::from_rgb8(239, 68, 68), FillRule::NonZero);
    ...
    scene.push_line(line, Color::from_rgb8(20, 184, 166), FillRule::NonZero);
